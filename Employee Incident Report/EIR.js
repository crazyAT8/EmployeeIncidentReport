...
let colors = document.getElementsByClassName('rgb')[0];
colors.addEventListener('click', (event) => {
    context.strokeStyle = event.target.value || 'white';
    // console.log(rgb())
});

let brusher = document.getElementsByClassName('brush')[0];
brusher.addEventListener('click', (event) => {
